...
";
  ...
  ";
            // line 171
            if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "featured_bottom", [], "any", false, false, true, 171)) {
                // line 172
                echo "    <!-- Feature Top (Call To Action)-->
    ";
                // line 173
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "featured_bottom", [], "any", false, false, true, 173), 173, $this->source), "html", null, true);
                echo "
    <!-- End of Feature top -->
  ";
            }
  ...
  ";
            // line 177
            $this->loadTemplate("@university_pro/footer/footer.html.twig", "modules/custom/university/templates/page/marches-publics.html.twig", 177)->display($context);
            // line 178
  ...
  ";
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo "</h1>
                  ...
                  ";
        // line 129
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_pdf", [], "any", false, false, true, 129), 0, [], "any", false, false, true, 129), 129, $this->source), "html", null, true);
        echo "
...
\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            ...
            echo "
            <div>
           <img src=\"coming_soon_bg.jpg\" />
            </div>

            <li>
             <a href=\"";
            // line 140
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "file", [], "any", false, false, true, 140), 140, $this->source), "html", null, true);
            echo "\">";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "titre", [], "any", false, false, true, 140), 140, $this->source), "html", null, true);
            echo "</a>
            </li>     
          ...
          ";
            // line 143
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["item"], "avis", [], "any", false, false, true, 143));
            foreach ($context['_seq'] as $context["_key"] => $context["avis"]) {
                // line 144
                echo "            <div>
            <label>";
                // line 145
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["avis"], "description", [], "any", false, false, true, 145), 145, $this->source), "html", null, true);
                echo ":</label>
            <a href=\"";
                // line 146
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["avis"], "url", [], "any", false, false, true, 146), 146, $this->source), "html", null, true);
                echo "\">Cliquez Ici</a>
            </div>
          ";
            }
...
\t\t\t\t           
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "sidebar_second", [], "any", false, false, true, 158)) {
            // line 159
            echo "              <div";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["sidebar_second_attributes"] ?? null), 159, $this->source), "html", null, true);
            echo ">
                <aside class=\"section\" role=\"complementary\">
                  ";
            // line 161
    ...
    {
        return array (  280 => 165,  273 => 161,  267 => 159,  265 => 158,  256 => 151,  249 => 149,  240 => 146,  236 => 145,  233 => 144,  229 => 143,  221 => 140,  213 => 134,  209 => 133,  202 => 129,  197 => 127,  192 => 124,  185 => 120,  179 => 118,  177 => 117,  172 => 115,  167 => 114,  163 => 113,  157 => 178,  155 => 177,  152 => 176,  146 => 173,  143 => 172,  141 => 171,  136 => 168,  134 => 113,  130 => 111,  127 => 110,  124 => 109,  121 => 108,  118 => 107,  116 => 106,  111 => 104,  107 => 102,  100 => 98,  96 => 96,  94 => 95,  91 => 94,  88 => 93,  84 => 91,  81 => 90,  75 => 87,  72 => 86,  70 => 85,  65 => 83,  56 => 77,  50 => 73,  47 => 72,  45 => 71,  43 => 70,  40 => 69,);
    }

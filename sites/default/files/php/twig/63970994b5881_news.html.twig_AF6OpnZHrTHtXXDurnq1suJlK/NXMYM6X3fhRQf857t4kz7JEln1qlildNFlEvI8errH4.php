...
/* modules/custom/actualites/templates/page/news.html.twig */
class __TwigTemplate_f5221d69d640f0b97de5c7e32be1c07e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (twig_in_filter("user", $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(($context["url"] ?? null))))) {
            // line 72
            echo "  ";
            $this->loadTemplate("@university_pro/header/header.html.twig", "modules/custom/actualites/templates/page/news.html.twig", 72)->display($context);
            // line 73
  ...
  ";
            ...
            // line 90
            echo "  ";
            $this->loadTemplate("@university_pro/footer/footer.html.twig", "modules/custom/actualites/templates/page/news.html.twig", 90)->display($context);
            // line 91
            echo "
";
        } else {
            // line 93
            echo "  ";
            $this->loadTemplate("@university_pro/header/header.html.twig", "modules/custom/actualites/templates/page/news.html.twig", 93)->display($context);
            // line 94
            echo "  <!-- Feature Top -->
  ";
            // line 95
  ...
  ";
            // line 168
            if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "featured_bottom", [], "any", false, false, true, 168)) {
                // line 169
                echo "    <!-- Feature Top (Call To Action)-->
    ";
                // line 170
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "featured_bottom", [], "any", false, false, true, 170), 170, $this->source), "html", null, true);
                echo "
    <!-- End of Feature top -->
  ";
            }
  ...
  ";
            // line 174
            $this->loadTemplate("@university_pro/footer/footer.html.twig", "modules/custom/actualites/templates/page/news.html.twig", 174)->display($context);
            // line 175
...
\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
           ...
           ";
            // line 135
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "corps", [], "any", false, false, true, 135), 135, $this->source), "html", null, true);
            echo "
             
            <div>
           <img src=\"";
            // line 138
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 138), 138, $this->source), "html", null, true);
            echo "\" />
            </div>

            <div>
            <label>Date d'actualité:</label>
            <p >";
            // line 143
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "date", [], "any", false, false, true, 143), 143, $this->source), "html", null, true);
            echo "</p>
            </div>
...
\t\t\t\t           
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "sidebar_second", [], "any", false, false, true, 155)) {
            // line 156
            echo "              <div";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["sidebar_second_attributes"] ?? null), 156, $this->source), "html", null, true);
            echo ">
                <aside class=\"section\" role=\"complementary\">
                  ";
            // line 158
    ...
    {
        return "modules/custom/actualites/templates/page/news.html.twig";
    }
    ...
    {
        return array (  264 => 162,  257 => 158,  251 => 156,  249 => 155,  240 => 148,  229 => 143,  221 => 138,  215 => 135,  210 => 134,  206 => 133,  197 => 127,  192 => 124,  185 => 120,  179 => 118,  177 => 117,  172 => 115,  167 => 114,  163 => 113,  157 => 175,  155 => 174,  152 => 173,  146 => 170,  143 => 169,  141 => 168,  136 => 165,  134 => 113,  130 => 111,  127 => 110,  124 => 109,  121 => 108,  118 => 107,  116 => 106,  111 => 104,  107 => 102,  100 => 98,  96 => 96,  94 => 95,  91 => 94,  88 => 93,  84 => 91,  81 => 90,  75 => 87,  72 => 86,  70 => 85,  65 => 83,  56 => 77,  50 => 73,  47 => 72,  45 => 71,  43 => 70,  40 => 69,);
    }
...
\t\t\t\t           
  ...
  {% endif %}", "modules/custom/actualites/templates/page/news.html.twig", "C:\\xampp\\htdocs\\university\\modules\\custom\\actualites\\templates\\page\\news.html.twig");
    }

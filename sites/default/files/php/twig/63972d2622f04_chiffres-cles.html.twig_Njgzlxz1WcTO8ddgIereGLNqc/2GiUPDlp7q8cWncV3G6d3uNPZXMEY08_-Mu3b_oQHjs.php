...
/* modules/custom/university/templates/page/chiffres-cles.html.twig */
class __TwigTemplate_ed8fb2006fb8e51992594642912ede673ab9c0418d6555d3962928bfc9efb5c8 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (twig_in_filter("user", $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(($context["url"] ?? null))))) {
            // line 72
            echo "  ";
            $this->loadTemplate("@university_pro/header/header.html.twig", "modules/custom/university/templates/page/chiffres-cles.html.twig", 72)->display($context);
            // line 73
  ...
  ";
            ...
            // line 90
            echo "  ";
            $this->loadTemplate("@university_pro/footer/footer.html.twig", "modules/custom/university/templates/page/chiffres-cles.html.twig", 90)->display($context);
            // line 91
            echo "
";
        } else {
            // line 93
            echo "  ";
            $this->loadTemplate("@university_pro/header/header.html.twig", "modules/custom/university/templates/page/chiffres-cles.html.twig", 93)->display($context);
            // line 94
            echo "  <!-- Feature Top -->
  ";
            // line 95
  ...
  ";
            // line 148
            if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "featured_bottom", [], "any", false, false, true, 148)) {
                // line 149
                echo "    <!-- Feature Top (Call To Action)-->
    ";
                // line 150
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "featured_bottom", [], "any", false, false, true, 150), 150, $this->source), "html", null, true);
                echo "
    <!-- End of Feature top -->
  ";
            }
  ...
  ";
            // line 154
            $this->loadTemplate("@university_pro/footer/footer.html.twig", "modules/custom/university/templates/page/chiffres-cles.html.twig", 154)->display($context);
            // line 155
...
\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 130
            echo "\t\t\t\t\t\t<li>";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "chiffre", [], "any", false, false, true, 130), 130, $this->source), "html", null, true);
            echo " - ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "titre", [], "any", false, false, true, 130), 130, $this->source), "html", null, true);
            echo "</li>
\t\t\t\t\t";
        }
        ...
        echo "\t\t\t\t  </u>
            ...
            ";
        // line 135
        if (twig_get_attribute($this->env, $this->source, ($context["page"] ?? null), "sidebar_second", [], "any", false, false, true, 135)) {
            // line 136
            echo "              <div";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["sidebar_second_attributes"] ?? null), 136, $this->source), "html", null, true);
            echo ">
                <aside class=\"section\" role=\"complementary\">
                  ";
            // line 138
    ...
    {
        return "modules/custom/university/templates/page/chiffres-cles.html.twig";
    }
    ...
    {
        return array (  237 => 142,  230 => 138,  224 => 136,  222 => 135,  217 => 132,  206 => 130,  202 => 129,  197 => 127,  192 => 124,  185 => 120,  179 => 118,  177 => 117,  172 => 115,  167 => 114,  163 => 113,  157 => 155,  155 => 154,  152 => 153,  146 => 150,  143 => 149,  141 => 148,  136 => 145,  134 => 113,  130 => 111,  127 => 110,  124 => 109,  121 => 108,  118 => 107,  116 => 106,  111 => 104,  107 => 102,  100 => 98,  96 => 96,  94 => 95,  91 => 94,  88 => 93,  84 => 91,  81 => 90,  75 => 87,  72 => 86,  70 => 85,  65 => 83,  56 => 77,  50 => 73,  47 => 72,  45 => 71,  43 => 70,  40 => 69,);
    }
...
\t\t\t\t  </u>
  ...
  {% endif %}", "modules/custom/university/templates/page/chiffres-cles.html.twig", "C:\\wamp64\\www\\university\\university\\modules\\custom\\university\\templates\\page\\chiffres-cles.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 70, "if" => 71, "include" => 72, "block" => 113, "for" => 129);
